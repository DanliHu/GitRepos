...
noStroke();
beginShape();
vertex(mouseX-9, mouseY-60);
vertex(mouseX+4, mouseY-30);
vertex(mouseX+37, mouseY-25);
vertex(mouseX+13, mouseY-3);
vertex(mouseX+19, mouseY+30);
vertex(mouseX-10, mouseY+15);
vertex(mouseX-39, mouseY+30);
vertex(mouseX-33, mouseY-3);
vertex(mouseX-57, mouseY-25);
vertex(mouseX-24, mouseY-30);
endShape(CLOSE);
if(mousePressed){
  fill(#F9F900);
  beginShape();
